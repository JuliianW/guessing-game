...
<html>
    ...
    <body>
        ...
        $_SESSION['percent'] = round($_SESSION['percent'], 0);
        ?>
        <div class="container">
            <table class="table"> 
                <thead>
                ...
                <div class="col-sm-4">
                    <div class = "well">
                        ...
                        <form action="#" method="post">
                            ...
                            <a href="leaderboards.php" class="btn btn-danger" role="button">Save & Exit</a>
                        </form>
...
//                    }
                    ...
                    echo "<div class='well'>";
                    echo "<h3>Your last try:</h3>";
                    echo "<p>Right answer:<strong> " . $_SESSION['citydb'] . "</strong></p>";
                    echo "<p>Your anser:<strong> $cityform </strong></p>";
                    echo "</div>";
                    echo "</div>";
